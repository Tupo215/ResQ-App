...
class User {
    ...
    async makeRequest(sentInfo) {
        ...
        try {
            ...
            if (audioBuffer) {
                ...
                if (victimsCount >= 3 || victimCondition.toLowerCase() == "unconscious" || victimCondition.toLowerCase() == "unknown" ) {
    ...
    async getHistory(userId) {
        ...
        try {
            ...
            let res = await userHandler.getMyReportHistory(userId);
            ...
            console.log("Error while ReportEmergency.getHistory ", Err.message);

            return {

                success: false,

                reason: "Error while ReportEmergency.getHistory "
